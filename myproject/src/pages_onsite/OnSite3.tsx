...
const OnSite3: React.FC = () => {
  ...
  try {
    ...
    history.push("/onsite/step4");
  } catch (error) {
    alert("견적 요청 실패:"+ error);
  ...
  return (
    <IonPage>
      <div className="container">
        ...
        <Title fontSize={24} content="출장 수리 (3/3)" />
      ...
      <div className="onsite3-button-wrapper">
        <Button onClick= {handleSubmit} content="정비 견적 요청" color= "orange" />
      </div>
